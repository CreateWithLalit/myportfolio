...
export function ThemeProvider({ children }) {
    ...
    useEffect(() => {
        ...
        root.style.setProperty('--portfolio-bg', isDark ? '#0f1117' : '#F9F7F2');
        root.style.setProperty('--portfolio-hero-bg', isDark ? '#1a1d2e' : '#F4F2ED');
        root.style.setProperty('--portfolio-alt-bg', isDark ? '#141720' : '#F0EFEA');
        root.style.setProperty('--portfolio-text', isDark ? '#f0f0f0' : '#2D3436');
        root.style.setProperty('--portfolio-text-muted', isDark ? '#9ca3af' : '#636E72');
        root.style.setProperty('--portfolio-border', isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)');
