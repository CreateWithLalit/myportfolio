export const skills = [
    {
        ...
        description:
            "Building responsive, accessible, and scalable web applications using modern JavaScript frameworks and best practices.",
    },
    {
        id: 2,
        icon: "Palette",
        title: "UI/UX Design",
        description:
            "Crafting intuitive and visually compelling user interfaces that deliver seamless, user-centered experiences.",
    },
    {
        id: 3,
        icon: "Zap",
        title: "Performance",
        description:
            "Optimizing load times, rendering efficiency, and runtime performance to ensure fast and smooth user experiences.",
    },
    {
        id: 4,
        icon: "Sparkles",
        title: "Animations",
        description:
            "Bringing interfaces to life with fluid, purposeful animations that enhance interactivity and visual storytelling.",
    },
];
